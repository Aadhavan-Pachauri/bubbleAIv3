...
import { CheckCircleIcon, LightBulbIcon, CodeBracketSquareIcon, ShareIcon as ShareIconSolid, SparklesIcon, HandThumbUpIcon as HandThumbUpSolid, HandThumbDownIcon as HandThumbDownSolid, EyeIcon } from '@heroicons/react/24/solid';
import { 
    CpuChipIcon, 
...
export const ChatMessage: React.FC<ChatMessageProps> = ({ 
  ...
  const availableModels = [
      ...
      { id: 'gemini_1.5_pro', name: 'Gemini 1.5 Pro' },
  ...
  if (isUser) {
    ...
    if (message.image_base64) {
        try { 
            ...
            // New format: Array of { type, data, name }
                    ...
                    <AnimatePresence>
                        {isMoreOpen && (
                            <>
                                ...
                                >
                                    {message.model && (
                                        <div className="px-3 py-2 text-[10px] text-gray-500 uppercase font-bold tracking-wider border-b border-white/5">
